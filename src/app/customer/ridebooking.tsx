...
const RideBooking = () => {
  ...
  const farePrices = useMemo(() => calculateFare(parseFloat(item?.distanceInKm)),
    [item?.distanceInKm]);
      ...
      <View style={rideStyles.bookingContainer}>
        <View style={commonStyles.flexRowBetween}>
          ...
          <View>
            ...
            <CustomText fontFamily='Medium' fontSize={12} style={{ opacity: 0.7 }}>Far: {item?.distanceInKm} KM</CustomText>
          </View>
